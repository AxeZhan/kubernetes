...
func TestValidationOptionsForPersistentVolume(t *testing.T) {
	tests := map[string]struct {
		...
		"old pv has invalid label-value in node affinity": {
			...
			expectValidationOpts: PersistentVolumeSpecValidationOptions{AllowInvalidLabelValueInNodeSelector: true},
		},
	}
...
func TestValidatePodUpdate(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			opts: PodValidationOptions{AllowInvalidLabelValueInNodeSelector: true},
		},
		{
			old: *podtest.MakePod("foo",
				podtest.SetAffinity(&core.Affinity{
